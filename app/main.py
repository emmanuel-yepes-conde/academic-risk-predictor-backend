...
from app.api.v1.endpoints.debug_notifications import router as debug_notif_router
...
app.include_router(debug_notif_router,   prefix="/api/v1", tags=["Debug — Notificaciones"])
if _waha_loaded:
